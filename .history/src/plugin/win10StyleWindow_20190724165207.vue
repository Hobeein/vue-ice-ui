    ...
    methods: {
        ...
        maximizeBtnClick(flag){
            if(flag === 'square'){
                ...
                this.windowShowStyle.width = window.innerWidth
                this.windowShowStyle.height = window.innerHeight
                this.windowShowStyle.top = 0
                this.windowShowStyle.left = 0
                ...
                // 还原
                this.windowShowStyle.width = this.lastWidth
                this.windowShowStyle.height = this.lastHeight
                this.windowShowStyle.top = this.lastTop
                this.windowShowStyle.left = this.lastLeft
