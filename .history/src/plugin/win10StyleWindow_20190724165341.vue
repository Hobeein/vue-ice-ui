...
const win10StyleWindow = {
    ...
    methods: {
        ...
        maximizeBtnClick(flag){
            if(flag === 'square'){
                // 最大化
                console.log(this.windowShowStyle)
                this.lastWidth = this.widthProp
                this.lastHeight = this.heightProp
                this.lastTop = this.topProp
                this.lastLeft = this.leftProp
                this.windowShowStyle.width = window.innerWidth + 'px'
                this.windowShowStyle.height = window.innerHeight + 'px'
                this.windowShowStyle.top = 0 + 'px'
                this.windowShowStyle.left = 0 + 'px'
                ...
                // 还原
                this.windowShowStyle.width = this.lastWidth + 'px'
                this.windowShowStyle.height = this.lastHeight + 'px'
                this.windowShowStyle.top = this.lastTop + 'px'
                this.windowShowStyle.left = this.lastLeft + 'px'
